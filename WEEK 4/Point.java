class Point{
    ...
    //COPY
    Point(Point obj){
        if(obj==null)throw new IllegalArgumentException("Cannot copy a null point");
        this.x=obj.x;
        this.y=obj.y;
        Point.objectCount++;
    }
    ...
    double PointDistance(Point obj){
        if(obj==null)throw new IllegalArgumentException("The passed object is null");
    ...
    double slope(Point obj){
        if(obj==null)throw new IllegalArgumentException("The passes object is null");
